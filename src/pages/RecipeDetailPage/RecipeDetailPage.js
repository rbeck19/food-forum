    ...
    return (
        <>
            <div className="head-container">
                <div className="page-header">{recipes.title}</div>
            </div>
            <div className="main-container">
                <div className="main-container-ingredients">
                    ...
                    <div className="recipe-engredient-container">
                        <Image className='recipe-image' cloudName="dhjlwaryv" publicId={recipes.image} />
                        <div className='recipe-desc'>{recipes.description}</div>
